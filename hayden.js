...
document.addEventListener('visibilitychange', function() {
    if (document.hidden) {
        ...
        $('[rel="icon"]').attr('href', "/img/favicon.ico");
        document.title = '但会乐观' + OriginTitle;
...
// 设置页脚博主
 $(document).ready(function(e) {
     $('.copyright').html('©2021 <i style="color:#FF6A6A;animation: announ_animation 0.8s linear infinite;" class="fa fa-heartbeat"></i> Hayden');
 });